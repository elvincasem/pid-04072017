...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>CHRIS - CHED Human Resource Information System</title>
        ...
        <link rel="stylesheet" href="<?=base_url()?>public/css/themes/amethyst.css">
        <!-- END Stylesheets -->
	 ...
	 <!-- Full Background -->
        ...
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <i class="fa fa-cube"></i> <strong>CHRIS</strong>
            </h1>
            <!-- END Login Header -->
